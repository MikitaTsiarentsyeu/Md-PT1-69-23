...
dict_hour = {
    0: ('двенадцать', 'двенадцатого', 'полночь'), 1: ('час', 'первого'),
    2: ('два', 'второго'), 3: ('три', 'третьего'),
    4: ('четыре', 'четвертого'), 5: ('пять', 'пятого'),
    6: ('шесть', 'шестого'),
    7: ('семь', 'седьмого'), 8: ('восемь', 'восьмого'),
    9: ('девять', 'девятого'), 10: ('десять', 'десятого'),
    11: ('одиннадцать', 'одиннадцатого'), 12: ('', 'двенадцатого', 'полдень')
}
