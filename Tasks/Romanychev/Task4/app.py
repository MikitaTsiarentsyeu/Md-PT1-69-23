...
def main():
    ...
    Process Flow:
    1. Gets the path to the input text file (input_file_path) and the maximum line size (max_chunk_size)
       using the user interface from the user_interface module.
    2. Processes the text file by splitting lines into chunks and saves the result in a separate file.
       This process is done using the process_file function from the file_processor module.
    """
