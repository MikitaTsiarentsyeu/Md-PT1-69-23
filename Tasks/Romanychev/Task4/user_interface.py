...
def get_max_chunk_size_from_user():
    """
    Prompt the user to input the maximum number of characters per line (max_chunk_size).

    Returns:
        int: The maximum allowed number of characters per line, provided by the user.

    Note:
    - The function uses a while loop to repeatedly prompt the user until a valid integer greater than MIN_CHUNK_SIZE is provided.
    - If the user enters a non-integer value, a ValueError is raised and an error message is displayed.
    """
...
def display_success_message(output_file_path):
    ...
    Args:
        output_file_path (str): The path to the output file where the processed text is saved.

    Note:
    - The function prints a success message indicating that the file processing is completed successfully.
    - It also provides the path to the output file where the processed text is saved.
    """
...
def display_file_not_found_error(input_file_path):
    ...
    Note:
    - The function prints an error message indicating that the specified input file is not found.
    """
...
def display_error_message(error):
    ...
    Note:
    - The function prints an error message indicating that an error occurred during file processing.
